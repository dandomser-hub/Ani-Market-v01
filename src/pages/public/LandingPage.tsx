        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-white mb-8 max-w-2xl leading-relaxed">
              Ani Market is a Demand-driven Agricultural Marketplace initially for Mainland Bicol. Farmers/Sellers respond to Demands posted by Buyer(s), transaction is triggered and Platform Matching happens automatically.
            </p>
